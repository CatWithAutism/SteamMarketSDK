...
public class GetPriceOverviewTests
{
	...
	public async Task GetMarketHistoryInDollarsSuccess()
	{
		...
		var reqUri = $"https://steamcommunity.com/market/priceoverview/?country={country}&currency={currency}&appid={appId}&market_hash_name={HttpUtility.UrlEncode(hashName)}";
