...
internal class PeriodPriceConverter : JsonConverter<List<PriceHistoryPeriodPrice>>
{
	...
	public override List<PriceHistoryPeriodPrice> Read(ref Utf8JsonReader reader, Type typeToConvert,
		JsonSerializerOptions options)
	{
		...
		{
			Period =
				DateTime.ParseExact(periodData[0].ToString(), "MMM dd yyyy HH: z", CultureInfo.InvariantCulture),
	...
	public override void Write(Utf8JsonWriter writer, List<PriceHistoryPeriodPrice> value,
