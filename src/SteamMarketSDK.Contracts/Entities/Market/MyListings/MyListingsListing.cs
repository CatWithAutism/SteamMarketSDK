...
public class MyListingsListing
{
	...
	[JsonPropertyName("cancel_reason")] public long CancelReason { get; set; }

	[JsonPropertyName("converted_currencyid")]
	public long ConvertedCurrencyId { get; set; }

	[JsonPropertyName("converted_fee")] public long ConvertedFee { get; set; }

	[JsonPropertyName("converted_fee_per_unit")]
	public long ConvertedFeePerUnit { get; set; }

	[JsonPropertyName("converted_price")] public long ConvertedPrice { get; set; }
	...
	[JsonPropertyName("fee_per_unit")] public long FeePerUnit { get; set; }

	[JsonPropertyName("item_expired")] public long ItemExpired { get; set; }

	[JsonPropertyName("listingid")] public long ListingId { get; set; }

	[JsonPropertyName("asset")] public MyListingsAsset MyListingsAsset { get; set; }
	...
	[JsonPropertyName("steamid_lister")] public long SteamIdLister { get; set; }

	[JsonPropertyName("time_created")] public long TimeCreated { get; set; }

	[JsonPropertyName("time_created_str")] public string TimeCreatedStr { get; set; }

	[JsonPropertyName("time_finish_hold")] public long TimeFinishHold { get; set; }
}