using SteamMarketSDK.Contracts.Entities.Common;
...
public class MyListingsBuyOrderDescription
{
	...
	[JsonPropertyName("contained_item")] public dynamic ContainedItem { get; set; }
	...
	[JsonPropertyName("fraudwarnings")] public List<dynamic> Fraudwarnings { get; set; }
	...
	[JsonPropertyName("item_expiration")] public dynamic ItemExpiration { get; set; }
	...
	[JsonPropertyName("market_fee")] public dynamic MarketFee { get; set; }

	[JsonPropertyName("market_fee_app")] public dynamic MarketFeeApp { get; set; }
	...
	[JsonPropertyName("owner_actions")] public List<SubjectAction> OwnerActions { get; set; }

	[JsonPropertyName("owner_descriptions")]
	public List<dynamic> OwnerDescriptions { get; set; }

	[JsonPropertyName("tags")] public List<dynamic> Tags { get; set; }
