...
public class SearchMarketItem
{
	...
	[JsonPropertyName("sale_price_text")] public string SalePriceText { get; set; }

	[JsonPropertyName("sell_listings")] public long SellListings { get; set; }

	[JsonPropertyName("sell_price")] public long SellPrice { get; set; }

	[JsonPropertyName("sell_price_text")] public string SellPriceText { get; set; }
}